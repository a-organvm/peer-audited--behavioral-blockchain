...
| KYC / identity verification runtime enforcement | `docs/legal/compliance.md` | Planned | (No runtime enforcement yet; reserved flag `KYC_ENFORCEMENT_ENABLED`) | `.env.example`, `/src/api/src/modules/compliance/compliance-policy.service.ts` capability flag | Compliance / Platform |
| Age 18+ strict enforcement | `docs/legal/compliance.md` | Planned | (No runtime age verification gate yet) | Policy only; tracked here for claim transparency | Compliance / Product |
